...
const commands: Record<string, Cmd> = {
  ...
  tools: {
    ...
    run: async () => {
      const reads = [
        "whoop_today", "whoop_day", "whoop_daily_brief", "whoop_profile", "whoop_calendar", "whoop_recovery",
        "whoop_sleep", "whoop_strain", "whoop_trend", "whoop_trend_pack", "whoop_weekly_plan", "whoop_compare", "whoop_stress",
        "whoop_sleep_need", "whoop_live_hr", "whoop_live_state", "whoop_live_stress", "whoop_activity_now",
        "whoop_workouts", "whoop_workout", "whoop_sports_catalog", "whoop_lift_prs",
        "whoop_lift_exercise", "whoop_lift_progression", "whoop_lift_history", "whoop_lift_overview",
        "whoop_lift_library", "whoop_lift_catalog", "whoop_journal", "whoop_journal_catalog",
        "whoop_behavior_impact", "whoop_cycle", "whoop_performance_assessment", "whoop_preferences",
